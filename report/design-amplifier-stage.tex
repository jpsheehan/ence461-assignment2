...
Due to physical size constraints and part availability we have opted to drive the positive supply rail down to the negative supply rail to achieve a low power state.
This is achieved with CMOS inverters, as these will be able to source enough current for the op-amps to operate.
